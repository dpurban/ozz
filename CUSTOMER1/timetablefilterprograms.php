                  ...
                  <form method = "post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <strong style="font-size: 15px">Total: &#8369;<span id = "ttl" class="totalprice">0.00</strong>
                      </div>
                    </div>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="row">
            ...
            <div class="row">
              <div class = "text-center" style="text-transform: uppercase; font-family: 'Montserrat', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-weight: 700; letter-spacing: 1px;margin-left: 2px">Filter by
                ...
                <a href="timetablefilterday.php" class="btn btn-default" style="background-color: gray; color: white; border-color: white; margin-left: 2px;"> Schedule</a>
              </div><br><br>
              <center>
  ...
  if(isset($_POST['join']))
  {
    ...
    $checkselmem = mysqli_query($conn,"SELECT * FROM tbl_member_class WHERE program_id = '$programid' AND member_id = '$member_id'");
    $checkselenroll = mysqli_query($conn,"SELECT * FROM tbl_enrolled_class WHERE program_id = '$programid' AND member_id = '$member_id'");
