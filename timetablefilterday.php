        ...
        <div class="row">
            ...
            <div class="row">
              <div class = "text-center" style="text-transform: uppercase; font-family: 'Montserrat', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-weight: 700; letter-spacing: 1px;margin-left: 2px">Filter by
                ...
                <a href="timetablefilterday.php" class="btn btn-default" style="background-color: gray; color: white; border-color: white; margin-left: 2px;font-weight: 700"> Day</a>
              </div><br/><br/>
              <center>
               <a href="#sub" data-toggle="modal" class="btn btn-default disabled" style="background-color: gray; color: white; border-color: white;" readonly>Subscribe Now</span></a>
             </center>
