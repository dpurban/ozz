...
<?php
  if(isset($_POST['join']))
  {
    ...
    $checkactive = mysqli_query($conn,"SELECT * FROM tbl_members WHERE member_id = '$memberid' AND isActive= 1");
...
<?php
    ...
    else
    {
                ...
                if($insert)
                {
                  ...
                  VALUES ('', 'Balance Made', '$programname', '$programtotal', 0, '$custinfo_id', CURRENT_TIMESTAMP)");
                   $insertcheck++;
               }
                else
                {
