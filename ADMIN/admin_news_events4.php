...
<body>
    ...
    <?php
                                    ...
                                    {
                                      $news_event_ID = $rows['news_event_ID'];
...
<?php
  ...
  if(isset($_POST['add']))
  {
    ...
    $insert = mysqli_query($conn, "INSERT INTO tbl_news_events 
                    VALUES('', '$eventname', '$eventstart', '$eventend', '$eventdesc', '$eventvenue', '$image')");
...
if(isset($_POST['delete']))
{
    ...
    $delete = mysqli_query($conn,"DELETE FROM tbl_news_events WHERE news_event_ID =$news_event_ID");
